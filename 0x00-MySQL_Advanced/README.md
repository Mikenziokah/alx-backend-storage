DVANCED MYSQL. understanding the below advanced concepts in mysql
...
2. SQL script that ranks country origins of bands, ordered by the number of (non-unique) fans
